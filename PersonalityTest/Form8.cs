...
namespace PersonalityTest
{
    public partial class Form8 : Form
    {
        ...
        public Form8(int a, int b, int c, int d, int e, int f, int a2, int b2, int c2, int d2, int e2, int f2, int a3, int b3, int c3, int d3, int e3, int f3, int a4, int b4, int c4, int d4, int e4, int f4, int a5, int b5, int c5, int d5, int e5, int f5, int a6, int b6, int c6, int d6, int e6, int f6, int a7, int b7, int c7, int d7, int e7, int f7)
        {
            j1 = a;
            j2 = b;
            j3 = c;
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            {
                Form9 window = new Form9(j1, j2, j3, j4, j5, j6, j7, j8, j9, j10, j11, j12, j13, j14, j15, j16, j17, j18, j19, j20, j21, j22, j23, j24, j25, j26, j27, j28, j29, j30, j31, j32, j33, j34, j35, j36, j37, j38, j39, j40, j41, j42, q1.a, q2.a, q3.a, q4.a, q5.a, q6.a);
                window.Show();
